...
(function () {
  ...
  Provider = (function () {
    ...
    Provider.prototype._valid_parameters = function (body) {
      ...
      correct_message_type = (body.lti_message_type === 'basic-lti-launch-request' || body.lti_message_type === 'ContentItemSelectionRequest');
      ...
      return correct_message_type && correct_version
    };
    ...
    Provider.prototype.parse_request = function (req, body) {
      ...
      this.launch_request = this.body.lti_message_type;
